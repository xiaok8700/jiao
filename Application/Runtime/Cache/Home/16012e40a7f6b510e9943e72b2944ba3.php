		...
		<div id="content">
			...
			<div class="conLeft">
				<div class="leftTop">
					...
					<ul> 
					    <?php if(is_array($content)): foreach($content as $key=>$v): ?><li><a href="http://localhost/jiaowu/index.php/Home/Index/article/id/<?php echo ($v["id"]); ?>"><span class="tongzhi"><?php echo ($v["timu"]); ?>
						  </span><span class="shijian"><?php echo ($v["time"]); ?></span></a></li><?php endforeach; endif; ?>
                        <?php
 for ($i=1; $i <= $a ; $i++) { echo "<a href=\"http://localhost/jiaowu/index.php/Home/Notice/index/page/$i\">$i</a>"; } ?>
